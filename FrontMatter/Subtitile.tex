...
\begin{center}
   ...
   \end{tikzpicture}
    ...
    {\large\bfseries Nguyễn Thị Kiều Chinh \par}

    %\vspace{3in}
    \vspace{2cm}

    {\Large\bfseries {CÔNG NGHỆ VÀ GIẢI PHÁP \\ THEO DÕI CHUYỂN ĐỘNG MẮT \\ HỖ TRỢ TRẺ EM RỐI LOẠN ĐỌC} \par}
    ...
    {\large\bfseries Cán bộ hướng dẫn: TS. Ngô Thị Duyên\par}
